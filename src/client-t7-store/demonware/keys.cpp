...
namespace demonware {
	...
	void calculate_hmacs_s1(const char* data_, const std::uint32_t data_size, const char* key, const std::uint32_t key_size, char* dst,
	...
	void derive_keys_s1() {
		...
		auto data_3 = utils::cryptography::hmac_sha1::compute(data.session_key, out_1);
