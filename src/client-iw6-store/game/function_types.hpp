...
#include <engine/iw6/CachedAssets_t.hpp>
...
namespace functions {
	...
	using R_AddCmdDrawTextT = void(const char* text, int max_chars, iw6::Font_s* font, float x, float y, float x_scale, float y_scale, float rotation,
